...
<style>
  ...
  #sketchpad {
      ...
      background-image:url(meerkats-small.jpg);
      cursor: pointer;
  }
  #clearbutton {
      /* font-size: 15px;
...
<body onload="init()">
    <!-- <div id="sketchpadapp"> -->
        <!-- <div class="leftside">
             Touchscreen and mouse support HTML5 canvas sketchpad with rainbow pen and background image.<br/><br/>
      ...
      <center>
        <!-- <div class="rightside"> -->
            ...
            <canvas id="sketchpad" height="600" width="300"></canvas>
            <br/>
            <input type="submit" value="Clear Sketchpad" id="clearbutton" onclick="clearCanvas(canvas,ctx);">
